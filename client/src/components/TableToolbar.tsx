...
const TableToolbar = () => {
	const { tasksData, setFilteredTaskData, setCurrentTaskData } = useContext(TasksContext);
	...
	const handleFilterTasks = () => {
		...
		setFilteredTaskData(newTasksData);
	};
	...
	return (
		<div className='flex flex-row space-x-2 relative'>
			...
			>
				{searchText ? <X className='w-4 h-4' /> : <SearchIcon className='w-4 h-4' />}
			</Button>
