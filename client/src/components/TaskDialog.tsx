...
const TaskDialog = ({ handleSubmit }: { handleSubmit: (task: Task) => void }) => {
	...
	const handleFormChange = (
		...
		const newValue = typeof e === 'string' || typeof e === 'number' ? e : e.target.value;
		setFormData((old): Task => ({ ...old!, [property as keyof Task]: newValue }));
	};
